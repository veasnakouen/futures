...
import com.mtp.auth.security.JwtRequestFilter;
...
public class SecurityConfig {
    ...
    private final com.mtp.auth.security.RateLimitFilter rateLimitFilter;

    public SecurityConfig(JwtRequestFilter jwtRequestFilter, com.mtp.auth.security.RateLimitFilter rateLimitFilter) {
    ...
    public PasswordEncoder passwordEncoder() {
        return new com.mtp.auth.security.AspNetIdentityPasswordEncoder();
    }

    @Bean
    public org.springframework.security.authentication.dao.DaoAuthenticationProvider authenticationProvider(
            com.mtp.auth.security.UserDetailsServiceImpl userDetailsService,

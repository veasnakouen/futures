...
public class PrescriptionController {
    ...
    private final GetPrescriptionsByPatientQueryHandler getByPatientHandler;
    ...
    public java.util.List<PrescriptionQueryResultDto> getByPatient(@PathVariable String patientId) {
        return getByPatientHandler.handle(new GetPrescriptionsByPatientQuery(patientId));
    }
    ...
    @PutMapping("/{id}")
    public ResponseEntity<PrescriptionQueryResultDto> update(@PathVariable String id,
            @Valid @RequestBody UpdatePrescriptionCommand command) {
        command.setId(id);

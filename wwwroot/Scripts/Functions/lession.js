        ...
        columns: [
            ...
            
            {
                ...
                render: function (data) {
                    return "<a href='#' onclick='lessionEdit(" + data + ")'><span class='glyphicon glyphicon-edit'></span> Edit</a>" + " | " + "<a href='#' onclick='LessionDelete(" + data + ")'><span class='glyphicon glyphicon-trash'></span> Delete</a>";
                },
                "width": "130px"
            }
        ],

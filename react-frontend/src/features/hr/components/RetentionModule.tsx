...
import { Heart, Search, ShieldCheck, AlertTriangle } from "lucide-react";
      ...
      <div className="border-none shadow-sm dark:bg-gray-800 rounded-md overflow-hidden bg-white">
        <Table hoverable className="w-full">
          <TableHead className="bg-gray-50 dark:bg-gray-700">
            ...
            <TableHeadCell className="py-3 px-4 text-[10px] uppercase">Role</TableHeadCell>
            <TableHeadCell className="py-3 px-4 text-[10px] uppercase">Flight Risk</TableHeadCell>
            <TableHeadCell className="py-3 px-4 text-[10px] uppercase">Retention Strategy</TableHeadCell>

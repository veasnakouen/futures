  ...
  return (
    <div className="fixed bottom-10 right-10 z-[100] animate-bounce-slow">
      <button
        ...
        className="w-20 h-20 bg-indigo-600 text-white rounded-md shadow-md shadow-indigo-500/50 flex items-center justify-center hover:scale-110 transition-all group border-4 border-white dark:border-gray-800"
      >
        <div className="absolute -top-2 -right-2 w-6 h-6 bg-emerald-500 rounded-md border-4 border-white dark:border-gray-800 animate-pulse"></div>
        <Activity
          size={32}
          className="group-hover:rotate-12 transition-transform"
        />
      </button>
      <div className="absolute bottom-24 right-0 w-80 bg-white dark:bg-gray-800 rounded-md shadow-md p-8 border dark:border-gray-700 hidden group-hover:block animate-fade-in">

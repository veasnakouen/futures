...
export const AssetGridCard: React.FC<AssetGridCardProps> = ({
  ...
  return (
    <div className="shadow-sm dark:bg-gray-800 p-0 hover:shadow-md transition-all group relative bg-white flex flex-col rounded-none border border-gray-100 dark:border-gray-700">
      {/* Image Area - Top Half */}
      ...
      <div className="p-3 sm:p-4 flex flex-col flex-1">
        ...
        <div className="flex flex-wrap gap-1.5 mb-2">
          <span className="text-[8px] font-black text-gray-500 uppercase px-1.5 py-0.5 bg-gray-100 dark:bg-gray-700">
            {a.assetType || "Other"}
          </span>
          <span className="text-[8px] font-black text-gray-500 uppercase px-1.5 py-0.5 bg-gray-100 dark:bg-gray-700">
            {a.serialNumber}
        ...
        {/* Custodian Footer */}
        <div className="flex flex-wrap items-end justify-between pt-3 mt-auto gap-y-2 gap-x-2 border-t border-gray-100 dark:border-gray-700">

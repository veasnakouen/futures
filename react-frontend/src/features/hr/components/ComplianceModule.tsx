      ...
      <div className="border-none shadow-sm dark:bg-gray-800 rounded-md overflow-hidden bg-white">
        <Table hoverable className="w-full">
          <TableHead className="bg-gray-50 dark:bg-gray-700">
            <TableHeadCell className="py-3 px-4 text-[10px] uppercase">Audit Program</TableHeadCell>
            <TableHeadCell className="py-3 px-4 text-[10px] uppercase">Compliance Framework</TableHeadCell>
            <TableHeadCell className="py-3 px-4 text-[10px] uppercase">Audit Score</TableHeadCell>

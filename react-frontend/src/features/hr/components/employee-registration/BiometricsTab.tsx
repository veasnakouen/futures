      ...
      <div className="max-w-md mx-auto text-center space-y-8">
          ...
          <div className="relative">
            ...
            {isEnrolling && (
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-20 h-20 border-4 border-blue-600 border-t-transparent rounded-md animate-spin"></div>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          {isEnrolling ? (
            ...
            <div className="p-4 bg-emerald-50 dark:bg-emerald-900/10 rounded-md border border-emerald-100 dark:border-emerald-900/20">
        ...
        <div className="pt-6 grid grid-cols-2 gap-4">
          <div className="p-4 border border-dashed dark:border-gray-700 rounded-md text-left">

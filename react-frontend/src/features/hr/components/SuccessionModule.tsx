...
import { Award, Search, Plus, ShieldCheck, UserCheck } from "lucide-react";
      ...
      <div className="border-none shadow-sm dark:bg-gray-800 rounded-md overflow-hidden bg-white">
        <Table hoverable className="w-full">
          <TableHead className="bg-gray-50 dark:bg-gray-700">
            <TableHeadCell className="py-3 px-4 text-[10px] uppercase">Critical Position</TableHeadCell>
            <TableHeadCell className="py-3 px-4 text-[10px] uppercase">Current Incumbent</TableHeadCell>
            <TableHeadCell className="py-3 px-4 text-[10px] uppercase">Designated Successor</TableHeadCell>
            <TableHeadCell className="py-3 px-4 text-[10px] uppercase">Readiness Timeline</TableHeadCell>

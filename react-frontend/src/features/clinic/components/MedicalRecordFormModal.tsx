          ...
          <ModalBody className="p-6 space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="col-span-2">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="p-2 bg-blue-50 text-blue-600 rounded-lg hover:bg-blue-100 dark:bg-blue-900/30 dark:text-blue-400 dark:hover:bg-blue-900/50 border-blue-200 dark:border-blue-800 transition-colors flex items-center justify-center h-[38px] w-[38px]"
                  >
              ...
              <div className="col-span-2">
                ...
                <textarea {...register("treatment")} rows={2} className="w-full px-3 py-2 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white" />
              </div>
              <div className="col-span-2">
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Prescription Notes</label>
                <textarea {...register("prescription")} rows={2} className="w-full px-3 py-2 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white" />
              </div>
            </div>
          </ModalBody>

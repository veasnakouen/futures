    ...
    public class ClientsController : ApiController
    {
        ...
        public async Task<IHttpActionResult> UpdateClient()
        {
            ...
            if (httpPostedFile != null)
            {
                ...
                //Delete Old Image
                var oldImagePath = Path.Combine(System.Web.HttpContext.Current.Server.MapPath("~/Images"), clientInDb.Photo);
        ...
        public IHttpActionResult DeleteClients(int id)
        {
            ...
            var imagePath = Path.Combine(System.Web.HttpContext.Current.Server.MapPath("~/Images"), clientInDb.Photo);
